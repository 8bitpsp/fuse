...
parse_xml( xmlDocPtr doc, settings_info *settings )
{
  ...
  while( node ) {
    ...
    if( !strcmp( (const char*)node->name, "rompentagon3" ) ) {
      xmlstring = xmlNodeListGetString( doc, node->xmlChildrenNode, 1 );
      free( settings->rom_pentagon_3 );
      settings->rom_pentagon_3 = strdup( (char*)xmlstring );
      xmlFree( xmlstring );
    } else
...
settings_write_config( settings_info *settings )
{
  ...
  if( settings->rom_pentagon_3 )
    xmlNewTextChild( root, NULL, (const xmlChar*)"rompentagon3", (const xmlChar*)settings->rom_pentagon_3 );
                       ...
                       int argc, char **argv )
{
  ...
  struct option long_options[] = {
    ...
    { "divide-masterfile", 1, NULL, 259 },
    { "divide-slavefile", 1, NULL, 260 },
    ...
    { "joystick-1", 1, NULL, 'j' },
    { "joystick-1-fire-1", 1, NULL, 265 },
    { "joystick-1-fire-10", 1, NULL, 266 },
    { "joystick-1-fire-2", 1, NULL, 267 },
    { "joystick-1-fire-3", 1, NULL, 268 },
    { "joystick-1-fire-4", 1, NULL, 269 },
    { "joystick-1-fire-5", 1, NULL, 270 },
    { "joystick-1-fire-6", 1, NULL, 271 },
    { "joystick-1-fire-7", 1, NULL, 272 },
    { "joystick-1-fire-8", 1, NULL, 273 },
    { "joystick-1-fire-9", 1, NULL, 274 },
    { "joystick-1-output", 1, NULL, 275 },
    { "joystick-2", 1, NULL, 276 },
    { "joystick-2-fire-1", 1, NULL, 277 },
    { "joystick-2-fire-10", 1, NULL, 278 },
    { "joystick-2-fire-2", 1, NULL, 279 },
    { "joystick-2-fire-3", 1, NULL, 280 },
    { "joystick-2-fire-4", 1, NULL, 281 },
    { "joystick-2-fire-5", 1, NULL, 282 },
    { "joystick-2-fire-6", 1, NULL, 283 },
    { "joystick-2-fire-7", 1, NULL, 284 },
    { "joystick-2-fire-8", 1, NULL, 285 },
    { "joystick-2-fire-9", 1, NULL, 286 },
    { "joystick-2-output", 1, NULL, 287 },
    { "joystick-keyboard-output", 1, NULL, 288 },
    {    "kempston-mouse", 0, &(settings->kempston_mouse), 1 },
    { "no-kempston-mouse", 0, &(settings->kempston_mouse), 0 },
    { "microdrive-file", 1, NULL, 289 },
    { "microdrive-2-file", 1, NULL, 290 },
    { "microdrive-3-file", 1, NULL, 291 },
    { "microdrive-4-file", 1, NULL, 292 },
    { "microdrive-5-file", 1, NULL, 293 },
    { "microdrive-6-file", 1, NULL, 294 },
    { "microdrive-7-file", 1, NULL, 295 },
    { "microdrive-8-file", 1, NULL, 296 },
    { "mdr-len", 1, NULL, 297 },
    ...
    { "playback", 1, NULL, 'p' },
    { "plus3disk", 1, NULL, 298 },
    {    "plusd", 0, &(settings->plusd), 1 },
    { "no-plusd", 0, &(settings->plusd), 0 },
    { "plusddisk", 1, NULL, 299 },
    {    "printer", 0, &(settings->printer), 1 },
    { "no-printer", 0, &(settings->printer), 0 },
    { "graphicsfile", 1, NULL, 300 },
    { "textfile", 1, NULL, 301 },
    {    "raw-s-net", 0, &(settings->raw_s_net), 1 },
    { "no-raw-s-net", 0, &(settings->raw_s_net), 0 },
    { "record", 1, NULL, 'r' },
    { "rom-128-0", 1, NULL, 303 },
    { "rom-128-1", 1, NULL, 304 },
    { "rom-16", 1, NULL, 305 },
    { "rom-48", 1, NULL, 306 },
    { "rom-beta128", 1, NULL, 307 },
    { "rom-interface-i", 1, NULL, 308 },
    { "rom-pentagon1024-0", 1, NULL, 309 },
    { "rom-pentagon1024-1", 1, NULL, 310 },
    { "rom-pentagon1024-2", 1, NULL, 311 },
    { "rom-pentagon1024-3", 1, NULL, 312 },
    { "rom-pentagon512-0", 1, NULL, 313 },
    { "rom-pentagon512-1", 1, NULL, 314 },
    { "rom-pentagon512-2", 1, NULL, 315 },
    { "rom-pentagon512-3", 1, NULL, 316 },
    { "rom-pentagon-0", 1, NULL, 317 },
    { "rom-pentagon-1", 1, NULL, 318 },
    { "rom-pentagon-2", 1, NULL, 319 },
    { "rom-pentagon-3", 1, NULL, 320 },
    { "rom-plus2-0", 1, NULL, 321 },
    { "rom-plus2-1", 1, NULL, 322 },
    { "rom-plus2a-0", 1, NULL, 323 },
    { "rom-plus2a-1", 1, NULL, 324 },
    { "rom-plus2a-2", 1, NULL, 325 },
    { "rom-plus2a-3", 1, NULL, 326 },
    { "rom-plus3-0", 1, NULL, 327 },
    { "rom-plus3-1", 1, NULL, 328 },
    { "rom-plus3-2", 1, NULL, 329 },
    { "rom-plus3-3", 1, NULL, 330 },
    { "rom-plus3e-0", 1, NULL, 331 },
    { "rom-plus3e-1", 1, NULL, 332 },
    { "rom-plus3e-2", 1, NULL, 333 },
    { "rom-plus3e-3", 1, NULL, 334 },
    { "rom-plusd", 1, NULL, 335 },
    { "rom-scorpion-0", 1, NULL, 336 },
    { "rom-scorpion-1", 1, NULL, 337 },
    { "rom-scorpion-2", 1, NULL, 338 },
    { "rom-scorpion-3", 1, NULL, 339 },
    { "rom-spec-se-0", 1, NULL, 340 },
    { "rom-spec-se-1", 1, NULL, 341 },
    { "rom-tc2048", 1, NULL, 342 },
    { "rom-tc2068-0", 1, NULL, 343 },
    { "rom-tc2068-1", 1, NULL, 344 },
    { "rom-ts2068-0", 1, NULL, 345 },
    { "rom-ts2068-1", 1, NULL, 346 },
    ...
    { "simpleide-masterfile", 1, NULL, 349 },
    { "simpleide-slavefile", 1, NULL, 350 },
    ...
    { "zxatasp-masterfile", 1, NULL, 353 },
    { "zxatasp-slavefile", 1, NULL, 354 },
...
#line 363"./settings.pl"
  ...
  while( 1 ) {
    ...
    case 259: settings_set_string( &settings->divide_master_file, optarg ); break;
    case 260: settings_set_string( &settings->divide_slave_file, optarg ); break;
    case 'D': settings->doublescan_mode = atoi( optarg ); break;
    case 262: settings->emulation_speed = atoi( optarg ); break;
    case 263: settings->frame_rate = atoi( optarg ); break;
    case 264: settings_set_string( &settings->if2_file, optarg ); break;
    case 'j': settings_set_string( &settings->joystick_1, optarg ); break;
    case 265: settings->joystick_1_fire_1 = atoi( optarg ); break;
    case 266: settings->joystick_1_fire_10 = atoi( optarg ); break;
    case 267: settings->joystick_1_fire_2 = atoi( optarg ); break;
    case 268: settings->joystick_1_fire_3 = atoi( optarg ); break;
    case 269: settings->joystick_1_fire_4 = atoi( optarg ); break;
    case 270: settings->joystick_1_fire_5 = atoi( optarg ); break;
    case 271: settings->joystick_1_fire_6 = atoi( optarg ); break;
    case 272: settings->joystick_1_fire_7 = atoi( optarg ); break;
    case 273: settings->joystick_1_fire_8 = atoi( optarg ); break;
    case 274: settings->joystick_1_fire_9 = atoi( optarg ); break;
    case 275: settings->joystick_1_output = atoi( optarg ); break;
    case 276: settings_set_string( &settings->joystick_2, optarg ); break;
    case 277: settings->joystick_2_fire_1 = atoi( optarg ); break;
    case 278: settings->joystick_2_fire_10 = atoi( optarg ); break;
    case 279: settings->joystick_2_fire_2 = atoi( optarg ); break;
    case 280: settings->joystick_2_fire_3 = atoi( optarg ); break;
    case 281: settings->joystick_2_fire_4 = atoi( optarg ); break;
    case 282: settings->joystick_2_fire_5 = atoi( optarg ); break;
    case 283: settings->joystick_2_fire_6 = atoi( optarg ); break;
    case 284: settings->joystick_2_fire_7 = atoi( optarg ); break;
    case 285: settings->joystick_2_fire_8 = atoi( optarg ); break;
    case 286: settings->joystick_2_fire_9 = atoi( optarg ); break;
    case 287: settings->joystick_2_output = atoi( optarg ); break;
    case 288: settings->joystick_keyboard_output = atoi( optarg ); break;
    case 289: settings_set_string( &settings->mdr_file, optarg ); break;
    case 290: settings_set_string( &settings->mdr_file2, optarg ); break;
    case 291: settings_set_string( &settings->mdr_file3, optarg ); break;
    case 292: settings_set_string( &settings->mdr_file4, optarg ); break;
    case 293: settings_set_string( &settings->mdr_file5, optarg ); break;
    case 294: settings_set_string( &settings->mdr_file6, optarg ); break;
    case 295: settings_set_string( &settings->mdr_file7, optarg ); break;
    case 296: settings_set_string( &settings->mdr_file8, optarg ); break;
    case 297: settings->mdr_len = atoi( optarg ); break;
    case 'p': settings_set_string( &settings->playback_file, optarg ); break;
    case 298: settings_set_string( &settings->plus3disk_file, optarg ); break;
    case 299: settings_set_string( &settings->plusddisk_file, optarg ); break;
    case 300: settings_set_string( &settings->printer_graphics_filename, optarg ); break;
    case 301: settings_set_string( &settings->printer_text_filename, optarg ); break;
    case 'r': settings_set_string( &settings->record_file, optarg ); break;
    case 303: settings_set_string( &settings->rom_128_0, optarg ); break;
    case 304: settings_set_string( &settings->rom_128_1, optarg ); break;
    case 305: settings_set_string( &settings->rom_16, optarg ); break;
    case 306: settings_set_string( &settings->rom_48, optarg ); break;
    case 307: settings_set_string( &settings->rom_beta128, optarg ); break;
    case 308: settings_set_string( &settings->rom_interface_i, optarg ); break;
    case 309: settings_set_string( &settings->rom_pentagon1024_0, optarg ); break;
    case 310: settings_set_string( &settings->rom_pentagon1024_1, optarg ); break;
    case 311: settings_set_string( &settings->rom_pentagon1024_2, optarg ); break;
    case 312: settings_set_string( &settings->rom_pentagon1024_3, optarg ); break;
    case 313: settings_set_string( &settings->rom_pentagon512_0, optarg ); break;
    case 314: settings_set_string( &settings->rom_pentagon512_1, optarg ); break;
    case 315: settings_set_string( &settings->rom_pentagon512_2, optarg ); break;
    case 316: settings_set_string( &settings->rom_pentagon512_3, optarg ); break;
    case 317: settings_set_string( &settings->rom_pentagon_0, optarg ); break;
    case 318: settings_set_string( &settings->rom_pentagon_1, optarg ); break;
    case 319: settings_set_string( &settings->rom_pentagon_2, optarg ); break;
    case 320: settings_set_string( &settings->rom_pentagon_3, optarg ); break;
    case 321: settings_set_string( &settings->rom_plus2_0, optarg ); break;
    case 322: settings_set_string( &settings->rom_plus2_1, optarg ); break;
    case 323: settings_set_string( &settings->rom_plus2a_0, optarg ); break;
    case 324: settings_set_string( &settings->rom_plus2a_1, optarg ); break;
    case 325: settings_set_string( &settings->rom_plus2a_2, optarg ); break;
    case 326: settings_set_string( &settings->rom_plus2a_3, optarg ); break;
    case 327: settings_set_string( &settings->rom_plus3_0, optarg ); break;
    case 328: settings_set_string( &settings->rom_plus3_1, optarg ); break;
    case 329: settings_set_string( &settings->rom_plus3_2, optarg ); break;
    case 330: settings_set_string( &settings->rom_plus3_3, optarg ); break;
    case 331: settings_set_string( &settings->rom_plus3e_0, optarg ); break;
    case 332: settings_set_string( &settings->rom_plus3e_1, optarg ); break;
    case 333: settings_set_string( &settings->rom_plus3e_2, optarg ); break;
    case 334: settings_set_string( &settings->rom_plus3e_3, optarg ); break;
    case 335: settings_set_string( &settings->rom_plusd, optarg ); break;
    case 336: settings_set_string( &settings->rom_scorpion_0, optarg ); break;
    case 337: settings_set_string( &settings->rom_scorpion_1, optarg ); break;
    case 338: settings_set_string( &settings->rom_scorpion_2, optarg ); break;
    case 339: settings_set_string( &settings->rom_scorpion_3, optarg ); break;
    case 340: settings_set_string( &settings->rom_spec_se_0, optarg ); break;
    case 341: settings_set_string( &settings->rom_spec_se_1, optarg ); break;
    case 342: settings_set_string( &settings->rom_tc2048, optarg ); break;
    case 343: settings_set_string( &settings->rom_tc2068_0, optarg ); break;
    case 344: settings_set_string( &settings->rom_tc2068_1, optarg ); break;
    case 345: settings_set_string( &settings->rom_ts2068_0, optarg ); break;
    case 346: settings_set_string( &settings->rom_ts2068_1, optarg ); break;
    case 347: settings_set_string( &settings->rs232_rx, optarg ); break;
    case 348: settings_set_string( &settings->rs232_tx, optarg ); break;
    case 349: settings_set_string( &settings->simpleide_master_file, optarg ); break;
    case 350: settings_set_string( &settings->simpleide_slave_file, optarg ); break;
    case 's': settings_set_string( &settings->snapshot, optarg ); break;
    case 352: settings_set_string( &settings->snet, optarg ); break;
    ...
    case 353: settings_set_string( &settings->zxatasp_master_file, optarg ); break;
    case 354: settings_set_string( &settings->zxatasp_slave_file, optarg ); break;
    case 355: settings_set_string( &settings->zxcf_pri_file, optarg ); break;
...
settings_copy_internal( settings_info *dest, settings_info *src )
{
  ...
  dest->rom_pentagon_3 = NULL;
  if( src->rom_pentagon_3 ) {
    dest->rom_pentagon_3 = strdup( src->rom_pentagon_3 );
    if( !dest->rom_pentagon_3 ) { settings_free( dest ); return 1; }
  }
...
settings_free( settings_info *settings )
{
  ...
  if( settings->rom_pentagon_3 ) free( settings->rom_pentagon_3 );
